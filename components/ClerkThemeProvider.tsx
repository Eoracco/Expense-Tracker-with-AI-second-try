...
interface ClerkThemeProviderProps {  // 修正拼写：Pros -> Props
    children: ReactNode;
}

export default function ClerkThemeProvider({  // 修正函数名，去掉 "Pros"
    children,
    ...
    return (
        <ClerkProvider
            appearance={{
                ...
                elements: {
                    formButtonPrimary: {
                        backgroundColor: theme === 'dark' ? '#10b981' : '#059669',  // 添加缺失的 {
                        '&:hover': {
